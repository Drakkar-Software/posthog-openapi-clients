...
/* tslint:disable */
/* eslint-disable */
import type { FunnelStepsResult } from './FunnelStepsResult';
export type FunnelStepsResults = {
    /**
     ...
     * * `Zulu` - Zulu
     */
    timezone?: FunnelStepsResults.timezone;
    result: Array<FunnelStepsResult>;
};
export namespace FunnelStepsResults {
    /**
     * Timezone the chart is displayed in
     *
     * * `Africa/Abidjan` - Africa/Abidjan
