...
export class PipelineImportAppsConfigsService {
     ...
     * @throws ApiError
     */
    public pipelineImportAppsConfigsList(
        projectId: string,
        limit?: number,
        offset?: number,
     ...
     * @throws ApiError
     */
    public pipelineImportAppsConfigsCreate(
        projectId: string,
     ...
     * @throws ApiError
     */
    public pipelineImportAppsConfigsRetrieve(
        id: number,
        projectId: string,
    ): CancelablePromise<PluginConfig> {
        return this.httpRequest.request({
     ...
     * @throws ApiError
     */
    public pipelineImportAppsConfigsUpdate(
        id: number,
        projectId: string,
        requestBody: PluginConfig,
    ): CancelablePromise<PluginConfig> {
     ...
     * @throws ApiError
     */
    public pipelineImportAppsConfigsPartialUpdate(
        id: number,
        projectId: string,
     ...
     * @throws ApiError
     */
    public pipelineImportAppsConfigsDestroy(
        id: number,
        projectId: string,
     ...
     * @throws ApiError
     */
    public pipelineImportAppsConfigsActivityRetrieve(
        id: number,
        projectId: string,
    ): CancelablePromise<any> {
        return this.httpRequest.request({
            method: 'GET',
            url: '/api/projects/{project_id}/pipeline_import_apps_configs/{id}/activity/',
            path: {
                'id': id,
                'project_id': projectId,
            },
     ...
     * @throws ApiError
     */
    public pipelineImportAppsConfigsFrontendRetrieve(
        id: number,
        projectId: string,
    ): CancelablePromise<any> {
        return this.httpRequest.request({
     ...
     * @throws ApiError
     */
    public pipelineImportAppsConfigsJobCreate(
        id: number,
        projectId: string,
        requestBody: PluginConfig,
    ): CancelablePromise<any> {
     ...
     * @throws ApiError
     */
    public pipelineImportAppsConfigsMigrateCreate(
        id: number,
        projectId: string,
        requestBody: PluginConfig,
    ): CancelablePromise<any> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/api/projects/{project_id}/pipeline_import_apps_configs/{id}/migrate/',
            path: {
                'id': id,
                'project_id': projectId,
            },
     ...
     * @throws ApiError
     */
    public pipelineImportAppsConfigsRearrangePartialUpdate(
        projectId: string,
        requestBody?: PatchedPluginConfig,
    ): CancelablePromise<any> {
        return this.httpRequest.request({
